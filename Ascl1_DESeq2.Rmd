...
date: '2023-02-16'
---
This is a script by Jens Bager Christensen to perform pseudobulk analysis on ASCL1-NEPs to identify their transcriptional response to neonatal injury.
...
Doing the analysis using P3 + P5 cells, expecting the ROS signal has subsided by then.
```{r}
#setting a seed, ensuring consistent clustering.
set.seed(123)
